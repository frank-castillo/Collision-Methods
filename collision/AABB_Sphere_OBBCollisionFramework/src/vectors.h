...
public:
	...
	friend bool operator>(const Vector2d& L, const Vector2d& R) { return L.LengthSq() > R.LengthSq(); }
	friend bool operator>=(const Vector2d& L, const Vector2d& R) { return (L.LengthSq() >= R.LengthSq()); }
	friend bool operator<(const Vector2d& L, const Vector2d& R) { return L.LengthSq() < R.LengthSq(); }
	friend bool operator<=(const Vector2d& L, const Vector2d& R) { return (L.LengthSq() <= R.LengthSq()); }
...
public:
	...
	T dist(Vector3d<T> v) const
	{
		return (*this - v).Length();
	}
	T distSq(Vector3d<T> v) const
	{
	...
	/*Check which Vectors are closer or further from the origin.*/
	friend bool operator>(const Vector3d& L, const Vector3d& R) { return L.LengthSq() > R.LengthSq(); }
	friend bool operator>=(const Vector3d& L, const Vector3d& R) { return (L.LengthSq() >= R.LengthSq()); }
	friend bool operator<(const Vector3d& L, const Vector3d& R) { return L.LengthSq() < R.LengthSq(); }
	friend bool operator<=(const Vector3d& L, const Vector3d& R) { return (L.LengthSq() <= R.LengthSq()); }
...
public:
	...
	T dist(Vector4d<T> v) const
	{
		return (*this - v).Length();
	}
	T distSq(Vector4d<T> v) const
	{
		return (*this - v).LengthSq();
	}
	...
	void set(T a, T b, T c) { x = a; y = b; z = c; }
	/*Check which Vectors are closer or further from the origin.*/
	friend bool operator>(const Vector4d& L, const Vector4d& R) { return L.LengthSq() > R.LengthSq(); }
	friend bool operator>=(const Vector4d& L, const Vector4d& R) { return (L.LengthSq() >= R.LengthSq()); }
	friend bool operator<(const Vector4d& L, const Vector4d& R) { return L.LengthSq() < R.LengthSq(); }
	friend bool operator<=(const Vector4d& L, const Vector4d& R) { return (L.LengthSq() <= R.LengthSq()); }
